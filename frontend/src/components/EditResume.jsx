...
const EditResume = () => {
    ...
    // Update array items items state using index 
    ...
    // Fetch resume details by Id using backend url
    ...
    // Helps in previewing and downloading the resume
    ...
    return (
        <div className="bg-[#f0eeeb]">
            ...
            <Modal isOpen={openPreviewModal} onClose={() => setOpenPreviewModal(false)} title={resumeData?.title}
                ...
                actionBtnIcon={isDownloading ? <Loader2 size={16} className="animate-spin" /> : (downloadSuccess ? <Check size={16} className="text-white" /> : <Download size={16} />)}
